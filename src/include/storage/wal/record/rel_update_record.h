...
struct RelUpdateRecord final : WALRecord {
    ...
    RelUpdateRecord(common::table_id_t tableID, common::column_id_t columnID,
        ...
        : WALRecord{WALRecordType::REL_UPDATE_RECORD}, tableID{tableID}, columnID{columnID},
          srcNodeIDVector{nullptr}, ownedSrcNodeIDVector{std::move(srcNodeIDVector)},
          dstNodeIDVector{nullptr}, ownedDstNodeIDVector{std::move(dstNodeIDVector)},
          relIDVector{nullptr}, ownedRelIDVector{std::move(relIDVector)}, propertyVector{nullptr},
